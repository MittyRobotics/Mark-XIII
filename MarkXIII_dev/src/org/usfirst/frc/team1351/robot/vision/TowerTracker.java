...
public class TowerTracker
{
	...
	public static final Scalar RED = new Scalar(0, 0, 255), BLUE = new Scalar(255, 0, 0), GREEN = new Scalar(0, 255, 0),
			...
			LOWER_BOUNDS = new Scalar(0, 0, 95), UPPER_BOUNDS = new Scalar(100, 255, 255);
	 ...
	 * 
	 * @param args
	 *            command line arguments just the main loop for the program and the entry points
	 */
	 ...
	 * 
	 * @param table
	 *            the network table you want to output to
	 */
