...
import org.usfirst.frc.team1351.robot.Atom;
import org.usfirst.frc.team1351.robot.TKOLogger;
import org.usfirst.frc.team1351.robot.TKOException;
import org.usfirst.frc.team1351.robot.TKOHardware;
...
public class GyroTurnAtom extends Atom
{
	...
	public void init()
	{
		try
		{
			TKOHardware.changeTalonMode(TKOHardware.getLeftDrive(), CANTalon.TalonControlMode.PercentVbus, p, i, d);
			TKOHardware.changeTalonMode(TKOHardware.getRightDrive(), CANTalon.TalonControlMode.PercentVbus, p, i, d);
